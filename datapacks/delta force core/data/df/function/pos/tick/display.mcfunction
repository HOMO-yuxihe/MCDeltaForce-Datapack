...
$execute if score $(name) pos matches ..-1 run function df:pos/tick/display/haavk with entity @s data
$execute if score $(name) pos matches 1.. run function df:pos/tick/display/gti with entity @s data
$execute if score $(name) pos matches 0 run function df:pos/tick/display/neutral with entity @s data
